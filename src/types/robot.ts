...
export type Command =
  ...
  | { type: 'SetMasterChassisTargetPreviousCurve'; x: number; y: number; yaw: number; xy_vmax: number; xy_amax: number; yaw_vmax: number; yaw_amax: number }
  ...
  | { type: 'StepUpR1Direct'; direction: number }
  ...
  | { type: 'StartOfflineTrajectory'; traj_id: number; mirror: number }
